...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&pGsz0JCI#ZemiiZxD5YACJkQXRQmjpQ1gGAwhZEfG7ndw3E_P4AI' : process.env.SESSION_ID,
...
ALWAYS_ONLINE: process.env.ALWAYS_ONLINE === undefined ? "ture" : process.env.ALWAYS_ONLINE,
